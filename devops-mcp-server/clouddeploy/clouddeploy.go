...
func (c *Client) ListDeliveryPipelines(ctx context.Context, projectID, location string) (*ListResult[*deploypb.DeliveryPipeline], error) {
	...
	return &ListResult[*deploypb.DeliveryPipeline]{Items: pipelines}, nil
...
func (c *Client) ListTargets(ctx context.Context, projectID, location string) (*ListResult[*deploypb.Target], error) {
	...
	return &ListResult[*deploypb.Target]{Items: targets}, nil
...
func (c *Client) ListReleases(ctx context.Context, projectID, location, pipelineID string) (*ListResult[*deploypb.Release], error) {
	...
	return &ListResult[*deploypb.Release]{Items: releases}, nil
...
func (c *Client) ListRollouts(ctx context.Context, projectID, location, pipelineID, releaseID string) (*ListResult[*deploypb.Rollout], error) {
	...
	return &ListResult[*deploypb.Rollout]{Items: rollouts}, nil
