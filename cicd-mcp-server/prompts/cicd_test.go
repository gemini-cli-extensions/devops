...
func TestDesignPrompt(t *testing.T) {
	...
	impl := &mcp.Implementation{
		Name:    "test-cicd",
		Title:   "Test Google Cloud CI/CD MCP Server",
		Version: "v0.0.1",
	}
	opts := &mcp.ServerOptions{
		Instructions: "Test Google Cloud CI/CD MCP Server",
		HasResources: false,
	}
	...
	if !foundPrompt {
		t.Error("Prompt 'cicd:design' not found on the server")
	}
